...
# Vercel Serverless Functions Handle CORS Automatically for Same-Origin
# But we keep it wide open here for local development against Vite.
# Vercel will ignore these on same-domain production requests.
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
def send_booking_email(booking: BookingRequest):
    ...
    # In Vercel, these must be set in the Project Environment Variables panel
    smtp_username = str(os.getenv("SMTP_USERNAME", "a41e69001@smtp-brevo.com"))
    smtp_password = str(os.getenv("SMTP_PASSWORD", ""))
    receiver_email = str(os.getenv("RECEIVER_EMAIL", "akadaan310@gmail.com"))
    smtp_sender   = str(os.getenv("SMTP_SENDER", "akadaan310@gmail.com"))
    ...
    <html>
      <body style="font-family: Arial, sans-serif; color: #1C1C1E; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background-color: #175680; color: white; padding: 20px; text-align: center; border-radius: 8px 8px 0 0;">
        ...
        <div style="padding: 20px; border: 1px solid #E5E7EB; border-top: none; border-radius: 0 0 8px 8px;">
            ...
            <h3 style="border-bottom: 2px solid #E07B39; padding-bottom: 5px; color: #175680;">Customer Details</h3>
            ...
            <h3 style="border-bottom: 2px solid #E07B39; padding-bottom: 5px; color: #175680;">Installation Details</h3>
            <ul style="list-style-type: none; padding: 0;">
            ...
            <h3 style="border-bottom: 2px solid #E07B39; padding-bottom: 5px; color: #175680;">Notes</h3>
...
async def health_check():
    return {"status": "ok", "service": "TrueHome Group API (Vercel Serverless)"}
